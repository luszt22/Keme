      ...
      <div className="flex">
        ...
        <main className="relative flex-1 p-6 md:p-12 max-w-6xl mx-auto overflow-x-hidden">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-black text-center leading-[1.05] tracking-tight mb-12 sm:mb-20 font-builder-extended"
              ...
              <div className="divide-y divide-gray-100">
                {PACKAGES.map((pkg, i) => (
                  <div key={i} className="flex items-center p-3 px-6 md:px-10 hover:bg-gray-50 transition-colors">
                    ...
                    <button 
                      onClick={() => checkVerificationBeforeSend()}
                      className="bg-[#E8EBF2] hover:bg-[#DEE3ED] transition-all text-slate-800 font-black py-2 px-6 rounded-xl min-w-[120px] text-base active:scale-[0.98]"
                    >
                      {pkg.price}
                    </button>
                  </div>
            ...
            <div className="border border-gray-200 rounded-2xl bg-white overflow-hidden shadow-sm divide-y divide-gray-100">
              {STANDARD_PACKAGES.map((pkg, i) => (
                <div key={i} className="flex items-center p-3.5 px-10 hover:bg-gray-50 transition-colors">
                  ...
                  <button 
                    onClick={() => checkVerificationBeforeSend()}
                    className="bg-[#E8EBF2] hover:bg-[#DEE3ED] transition-all text-slate-800 font-black py-2.5 px-8 rounded-xl min-w-[140px] text-lg active:scale-[0.98]"
                  >
                    {pkg.price}
                  </button>
                </div>
